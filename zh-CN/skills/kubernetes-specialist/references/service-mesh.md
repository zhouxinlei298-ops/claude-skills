...
1. **从 permissive mTLS 开始**，逐步迁移到严格模式
2. **使用 circuit breakers** 防止级联故障
3. **设置合理的超时**和重试预算
4. **启用分布式链路追踪**以提高可观测性
5. **生产前使用故障注入进行测试**
6. **监控 sidecar 资源使用**并相应调整
7. **使用流量镜像**安全验证新版本
8. **实施 authorization policies** 实现零信任
9. **保持 service mesh 版本更新**以获得安全补丁
10. **在 VirtualService 中记录流量路由决策**