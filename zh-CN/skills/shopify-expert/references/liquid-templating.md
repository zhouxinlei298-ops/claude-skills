...
- 构建或定制 Shopify Online Store 2.0 主题
- 使用 JSON 模式创建自定义区块和区块
- 实现产品、集合和页面模板
- 在模板中处理 metafields 和 metaobjects
- 使用 Liquid 逻辑构建动态内容

## 何时不要使用

- 无头电商（使用 Storefront API）
- 应用开发（使用 Remix/React 和 Admin API）
- 复杂的业务逻辑（使用 Shopify Functions）
