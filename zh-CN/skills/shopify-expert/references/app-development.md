...
- 主题定制（使用 Liquid）
- 面向客户的商店前端（使用 Storefront API）
- 简单的产品展示（使用 Liquid 或 Storefront API）
- 仅结账定制（使用 Checkout Extensions）
...
- **Storefront API** - 用于面向客户的功能
- **Checkout Customization** - 用于结账扩展
- **Liquid Templating** - 用于主题应用扩展