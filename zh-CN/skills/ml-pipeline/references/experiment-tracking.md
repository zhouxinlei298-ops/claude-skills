...
实验跟踪实现了 ML 开发中的可复现性、比较性和协作性。它捕获超参数、指标、工件和模型版本，确保每个实验都可以被复现和比较。

## 何时使用本参考

- 设置 MLflow 进行实验跟踪
- 实现 Weights & Biases 集成
- 创建模型注册表和版本控制
- 比较实验和选择模型
- 构建自定义跟踪解决方案
...
- `training-pipelines.md` - 将跟踪与训练集成
- `model-validation.md` - 验证跟踪的模型
- `pipeline-orchestration.md` - 在自动化管道中跟踪

## 交叉引用技能

- **DevOps Engineer** - MLflow 服务器部署
- **Data Engineer** - 工件存储集成
